              ...
              <li>
                <div className="flex pl-2 ">
                  ...
                  <div className="border-l pl-8 pt-2">
                    <h6>Name</h6>
                    <span className="text-[#9f9f9f]">Mohammed Irfan M</span>
                  </div>
                </div>
              </li>
              <li>
                <div className="flex pl-2">
                  ...
                  <div className="border-l pl-8 pt-4">
                    ...
                    <span className="text-[#9f9f9f]">
                      Vadakkencherry,Palakkad,Kerala
                    </span>
                  </div>
                </div>
              </li>
              <li>
                <div className="flex pl-2">
                  ...
                  <div className="border-l pl-8 pt-4">
                    <h6>Call Me</h6>
                    <span className="text-[#9f9f9f]">
                      <a href="tel:919746929076">+91 9746929076</a>
                    </span>
                  </div>
                </div>
              </li>
              <li>
                <div className="flex pl-2 ">
                  ...
                  <div className="border-l pl-8 pt-4 max-sm:break-all">
                    <h6>Email Me</h6>
                    <span className="text-[#9f9f9f] ">
                      <a href="mailto:irfanpkd2002@gmail.com">
