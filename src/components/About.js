          ...
          <div className="ml-14 max-md:ml-0">
            <div className="p-5 ">
              ...
              <h1 className="text-3xl font-bold p-3 max-md:text-xl">
                I'm Mohammed Irfan M, Web Developer
              </h1>
              <p className="text-[#9f9f9f] p-2 text-sm">
                I am a Bsc cs graduate student at Nethaji Arts and Science Collage Nemmara. I have a passion for
                developing solutions and am a keen learner. I enjoy working in
                Mearn Stack and collaborating with Technical Societies. As a web developer, I love creating Advance websites and Web apps. My goal is to create value and impact to bring
            ...
            <div className="flex flex-col max-md:ml-5">
              <div className="flex max-md:flex-col max-md:p-0 p-2 ">
                <div className="flex pl-4 max-md:pl-0">
                  <span>Name:</span>
                  <p className="pl-2 text-[#9f9f9f]">Mohammed Irfan M</p>
                </div>
              ...
              <div className="flex max-md:flex-col  max-md:p-0 p-2">
                ...
                <div className="flex pl-[283px] max-md:pl-0">
                  <span>Live: </span>
                  <p className="pl-2 text-[#9f9f9f]">Kerala ,India</p>
                </div>
              </div>
            </div>
            <div>
              <button class="mt-2 ml-5 bg-[#009e66] hover:bg-[#0e522b] text-white font-bold py-2 px-4 rounded-full mb-3">
                <Link to="https://drive.google.com/file/d/1BIctoX9Ou3SuPsm6NLMevYhC2gRa6a1a/view?usp=drivesdk" target="_blank">
